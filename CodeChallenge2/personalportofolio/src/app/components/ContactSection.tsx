...
export default function ContactSection () {
    return (
        <div id="experince-section" className="relative bg-[#131010] h-screen w-full grid grid-cols-1 md:grid-cols-8 grid-rows-9 gap-4 bg-cover bg-center bg-[url('../app/Picture4.png')]">
            ...
            <div className="row-start-3 row-span-6 col-start-1 md:col-start-2 col-span-1 md:col-span-6 bg-[#FFF0DC] p-6 rounded-lg shadow-lg">
                ...
                <div className="mt-6 text-center">
                    ...
                    <div className="flex justify-center space-x-4 mt-2">
                        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-[#D98324] hover:underline w-[60px]">
