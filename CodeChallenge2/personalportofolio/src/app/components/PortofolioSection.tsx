...
export default function PortofolioSection() {
  return (
    <div id="portofolio-section" className="relative bg-[#D98324] h-screen w-full grid grid-cols-1 md:grid-cols-8 grid-rows-9 gap-4 bg-cover bg-center bg-[url('../app/Picture4.png')] text-[#FFF0DC]">
        ...
        <div className="bg-[#131010] p-5 row-start-3 row-span-6 col-start-1 md:col-start-2 col-span-1 md:col-span-6 rounded-3xl flex flex-col md:flex-row gap-10 justify-center text-[14px]">
            <div className="h-48 md:h-full w-full relative rounded-3xl">
