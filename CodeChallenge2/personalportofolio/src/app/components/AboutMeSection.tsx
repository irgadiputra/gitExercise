...
export default function AboutMeSection() {
  return (
    <div id="aboutme-section" className="relative bg-[#D98324] h-screen w-full grid grid-cols-1 md:grid-cols-8 grid-rows-9 gap-4 bg-cover bg-center bg-[url('../app/Picture4.png')] text-[#FFF0DC]">
