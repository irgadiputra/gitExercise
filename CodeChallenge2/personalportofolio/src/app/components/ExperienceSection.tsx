export default function ExperienceSection () {
    return (
        <div id="experince-section" className="relative bg-[#131010] h-screen w-full grid grid-cols-1 md:grid-cols-8 grid-rows-9 gap-4 bg-cover bg-center bg-[url('../app/Picture4.png')]">
            ...
            <div className="row-start-4 row-span-5 col-start-1 md:col-start-2 col-span-1 md:col-span-6 gap-5 flex flex-col md:flex-row w-full">
                <div className="bg-[#D98324] p-5 row-span-3 col-start-1 md:col-start-2 col-span-1 md:col-span-6 rounded-3xl justify-center text-[14px] h-fit w-full flex flex-col gap-5">
                    <div className="font-extrabold text-[#FFF0DC] text-[25px] md:text-[35px]">
                        Education
                    </div>
